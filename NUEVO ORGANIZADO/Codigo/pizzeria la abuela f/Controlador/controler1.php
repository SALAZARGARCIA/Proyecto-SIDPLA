...
if (isset($_POST["registrarVenta"])) {
 ...
 values($cart_id,$c[product_id],$c[q],$vs)");
        ...
        print "<script>alert('Venta procesada exitosamente');window.location='../Vista/domicilios en espera.php';</script>";
    } else {
        print "<script>alert('Regístrate o inicia sesión para pedir un domicilio.');window.location='../Vista/inicio_sesion.php';</script>";
    }
}
