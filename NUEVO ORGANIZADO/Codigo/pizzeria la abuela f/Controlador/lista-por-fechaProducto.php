...
<?php if (isset($_POST['form_sent']) && $_POST['form_sent'] == "true") { ?>
...
$pdf->Cell(180, 13, 'Obvservacion', 1);
$pdf->Ln(13);
...
$resultado = mysqli_query($mysqli, "SELECT producto.cod_producto, producto.nom_prod, domicilio_has_producto.cantidad,  
 ...
 JOIN domicilio
 ON(domicilio.cod_dom=domicilio_has_producto.domicilio_cod_dom) WHERE nom_prod='$SPRODUCTO' AND Fecha_Hora BETWEEN '$START_DATE' AND '$END_DATE'");
