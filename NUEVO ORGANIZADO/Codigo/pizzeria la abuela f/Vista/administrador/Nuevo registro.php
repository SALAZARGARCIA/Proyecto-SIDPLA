                ...
                <center>
                    ...
                    <?php if (!empty($_GET['m']) && !empty($_GET['action'])) { ?>
                        ...
                        <form enctype="multipart/form-data" action="#" method="post">
                            ...
                            <label for="Stok_min"><span class="icon-circle-with-minus"></span> Stok Min</label>
                            <input type="text" name="Stok_min" placeholder="Stok Min" required>

                            <br>
                            <br>

                            <label for="Stok_max"><span class="icon-circle-with-plus"></span> Stok Max</label>
                            ...
                            <label for="tamaño_tamaño"><span class="icon-select-arrows"></span> Tamaño</label>
                            ...
                            <label for="Valor_unitario"><span class="icon-credit"></span> Valor</label>
