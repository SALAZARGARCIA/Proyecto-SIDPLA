...
//  		Instancia la clase editar que se encuentra al final de cada registro//	
            ...
            case 'cancelar':
            print "<script>window.location='personas.php';</script>";
                break;
        }
    }
    ?>
                            ...
                            <li>
                                ...
                                <?php if (!empty($_GET['Num_Documento_per']) && !empty($_GET['action'])) { ?>
                                    ...
                                    <form action="#" method="post">
                                        ...
                                        <h4>
                                            <label>
                                                Numero Documento: <?php echo $persona->__GET('Num_Documento_per'); ?>
                                            </label>

                                            <input type="number" name="Num_Documento_per2" id="Num_Documento_per2" value="<?php echo $persona->__GET('Num_Documento_per'); ?>" placeholder="Numero Documento" style="display:none" required>

                                            <br>
                                            <br>

                                            <label>
                                                Tipo Documento:  <?php echo $persona->__GET('tipo_doc'); ?>
                                            </label>

                                            <input type="text" name="tipo_doc" id="tipo_doc" value="<?php echo $persona->__GET('tipo_doc'); ?>" style="display:none" required>
                                            ...
                                            if($persona->__GET('rol_Rol')==$row['Rol']){ 
                                            echo '<option value="' . $row['Rol'] . '" selected>' . $row['Rol'] . '</option>';}
                                            else{
