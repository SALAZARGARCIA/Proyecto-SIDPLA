                        ...
                        <li>
                            ...
                            if ($query->rowCount() > 0):
                                ...
                                <option value="ACOMPAÑANTE">ACOMPAÑANTES</option>
                                    ...
                                    <button type="submit" class="comprar" onclick = "this
                                                .form.action = '?action=buscar';" ><span class="icon-magnifying-glass"></span> <b>Buscar</b></button>
                                </form>
                                <br><br>
                                <?php
                                if (isset($_REQUEST['action'])) {
                                ...
                                <table class="listar" >
                                    ...
                                    <?php $todos= $_POST['tipo']; foreach ($model->Listar_prod($todos) as $r): ?>
                                        <tr> 
                                            ...
                                            <td>
                                                <a href="Editar producto.php?action=editar&Cod_producto=<?php echo $r->Cod_producto; ?>">Editar<span class="icon-edit"></span></a>
                                            </td>

                                            <td>
                                                <a href="?action=eliminar&Cod_producto=<?php echo $r->Cod_producto; ?>" onclick="return confirm('¿Esta seguro de eliminar este Producto?')">Eliminar<span class="icon-trash"></span></a>
                                            </td>
