                    ...
                    <tr>
                        <td>			
                            ...
                            <br>
                                 ...
                                 */
                                $products = $con->query("select * from producto where tipo_producto_tipo_prod = 'BEBIDA'");
                                ?>
                            ...
                            <td>
                                ...
                                <img src="MEDIA/<?php echo $r->Foto_prod; ?>" width="180px" height="150px">

                                <?php echo $r->tamaño_tamaño; ?>

                                <br>

                                $ <?php echo $r->Valor_unitario; ?>
                                ...
                                ?>
                                <?php if ($found): ?><br>
                                    <a href="cart.php" class="comprar">Agregado<span class="icon-shopping-cart"></span></a>
                                ...
                                <?php else: ?>
                                    <form class="form-inline" method="post" action="../Controlador/addtocart.php">
                                        ...
                                        <button type="submit" class="comprar">Agregar al carrito <span class="icon-shopping-cart"></span></button>
                                    </form>	
