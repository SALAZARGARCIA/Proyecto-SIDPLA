    		...
    		<div class="misdomicilios">
               ...
               <div class="prod__dom">
                   ...
                   <div id="detalleprods">
                      ...
                      <br><br>
                      <?php  
                        if($x->estado_domicilio_Estado_dom == 'EN ESPERA'):
                      ?>
                      <a class="boton_peligro" href="../Controlador/persona.control.php?Cambio_estado=Cancelado&ID=<?php echo $x->Cod_dom; ?>">Cancelar Domicilio</a>
                    <?php endif; ?>
               </div>
    		</div>
      <?php } }?>
