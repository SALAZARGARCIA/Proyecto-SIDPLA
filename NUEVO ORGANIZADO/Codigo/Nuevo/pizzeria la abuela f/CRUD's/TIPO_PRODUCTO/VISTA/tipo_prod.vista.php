...
<!--LABEL USUARIO FINAL -->
<label>Tipo producto por Modificar: <?php echo $tipo_prod->__GET('tipo_prod'); ?> </label>
...
<br><br><label>TIPO PRODUCTO</label>
 <input type="text" name="tipo_prod2" id="tipo_prod2" value="<?php echo $tipo_prod->__GET('tipo_prod'); ?>" placeholder="Tipo producto" required>
