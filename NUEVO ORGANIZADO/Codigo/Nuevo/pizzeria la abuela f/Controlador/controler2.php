...
if (isset($_POST["registrarVenta"])) {
 ...
 values($cart_id,$c[product_id],$c[q],$vs)");
        ...
        print "<script>alert('Venta procesada exitosamente');window.location='../Vista/empleado/productos.php';</script>";
    } else {
...
if (isset($_POST["comentar"])) { // Verifica si el botón oprimido es el de comentar
 ...
 values('$com','$idper','$tdocper',NOW())");
    ...
    print "<script>alert(\"Gracias por tu opinión\");window.location='../Vista/empleado/coment.php';</script>";
}
