...
│-------------------------------------------------------------------*/																	 
 ...
 Cel_per=newCel_per, Direc_per=newDirec_per, Correo_per=newCorreo_per, tipo_doc=newtipo_doc, Rol_rol=newRol_rol WHERE  Num_Documento_per= OLDNum_Documento_per;
