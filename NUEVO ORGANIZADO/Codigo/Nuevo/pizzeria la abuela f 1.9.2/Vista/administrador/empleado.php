            ...
            <table class="reg1">
                ...
                <center>
                    ...
                    <?php while ($d = $domicilio_h_p->fetch_object()): ?>
                        ...
                        <p> Domicilio: <?php echo $d->Cod_dom; ?></p><br>
                        ...
                        <table class="lis myform<?php echo $numform ?>" ><p>Productos</p> 
                            <thead>
                            <th>ID</th>
                            <th>Foto</th>
                            <th>Nombre</th>
                        ...
                        <table class="lis">
                            ...
                            <td WIDTH="150"><center><form class="form-inline" method="post" action="../../Controlador/controler3.php">
