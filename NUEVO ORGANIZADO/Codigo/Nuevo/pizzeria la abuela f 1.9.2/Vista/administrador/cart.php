                    ...
                    <ul class="slides">
                        ...
                        <center>			
                            ...
                            <table class="listar1" >
                                    ...
                                    foreach ($_SESSION["cart"] as $c):
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                ?>
                                                <a href="../../Controlador/delfromcart2.php?id=<?php echo $c["product_id"]; ?>" class="btn btn-danger">Eliminar</a>
                                            </td>
                                ...
                                <form class="form-horizontal" method="post" action="../../Controlador/controler3.php">
